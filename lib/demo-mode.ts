...
import galleriesData from '@/data/mock/gallery.json'
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetGalleries') || query.includes('nodeGalleries')) {
      return loadMockData('gallery.json')
    }
